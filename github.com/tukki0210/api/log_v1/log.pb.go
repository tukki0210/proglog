...
func (x *ProdeceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProdeceResponse) ProtoMessage() {}

func (x *ProdeceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_log_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProdeceResponse.ProtoReflect.Descriptor instead.
func (*ProdeceResponse) Descriptor() ([]byte, []int) {
	return file_api_v1_log_proto_rawDescGZIP(), []int{2}
}

func (x *ProdeceResponse) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
var file_api_v1_log_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x6f, 0x64, 0x65, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x6c, 0x6f, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x52, 0x06, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x32, 0x8d, 0x02, 0x0a,
	...
	0x2e, 0x50, 0x72, 0x6f, 0x64, 0x65, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x44, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	...
	0x17, 0x2e, 0x6c, 0x6f, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x65, 0x63, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x42, 0x21, 0x5a, 0x1f,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x75, 0x6b, 0x6b, 0x69,
	0x30, 0x32, 0x31, 0x30, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6c, 0x6f, 0x67, 0x5f, 0x76, 0x31, 0x62,
...
var file_api_v1_log_proto_goTypes = []interface{}{
	...
	(*ProdeceResponse)(nil), // 2: log.v1.ProdeceResponse
...
var file_api_v1_log_proto_depIdxs = []int32{
	...
	2, // 6: log.v1.Log.Produce:output_type -> log.v1.ProdeceResponse
	4, // 7: log.v1.Log.Consume:output_type -> log.v1.ConsumeResponse
	4, // 8: log.v1.Log.ConsumeStream:output_type -> log.v1.ConsumeResponse
	2, // 9: log.v1.Log.ProduceStream:output_type -> log.v1.ProdeceResponse
